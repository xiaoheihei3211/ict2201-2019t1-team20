    ...
    invalidRoute(status) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const alert = yield this.alertController.create({
                ...
                message: 'Directions request failed due to location ' + status.replace(/_/g, ' ').toLowerCase() + ".",
                buttons: ['OK']
            });
            yield alert.present();
        });
    ...
    resetDisqualified() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const quit = yield this.alertController.create({
                header: 'Take Note',
                subHeader: 'Diverted from route for too long',
        ...
        navigator.geolocation.getCurrentPosition(function (position) {
            ...
            if (smallest > 500) {
                ...
                if (count == 5) {
                    ...
                    that.directionsDisplay.setPanel(that.directionsPanel.nativeElement);
                    that.directionsDisplay.setDirections();
                }
            }
            else {
            ...
            distComplete = google.maps.geometry.spherical.computeDistanceBetween(complete, complete);
            console.log("number 2: ", that.totalDistance); //<---- the route distance

...
let NavigatePageModule = class NavigatePageModule {
};
...
module.exports = ".map {\n  height: 70%;\n  width: 100%;\n}\n\nion-card {\n  max-height: 70px;\n  overflow: scroll;\n  position: absolute;\n  z-index: 1;\n  background-color: #FFFFFF !important;\n}\n\n.scroll {\n  height: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var startMarker;
var endMarker;
let NavigatePage = class NavigatePage {
    constructor(fb, alertController, geolocation, router, zone, user, afs) {
        this.fb = fb;
    ...
    //predicts the user's start location using google map places api
    updateSearchResults() {
        if (this.autocomplete.input == " ") {
            this.autocompleteItems = [];
            return;
        }
        //restricting it to Singapore only
    ...
    //predicts the user's end location using google map places api
    ...
    //replaces the start searchbar with the result user chose
    ...
    //replaces the finish searchbar with the result user chose
    ...
    //Used to display error messaages to user incase of invalidity.
    invalidRoute(status) {
    ...
    //Used to display error messaages to user when they off track for too long.
    resetDisqualified() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const quit = yield this.alertController.create({
                header: 'So sorry...',
    ...
    //Used to display error messaages to user once they complete.
    routeCompleted(points) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const redirect = yield this.alertController.create({
            ...
            yield redirect.present();
        });
    }
    //to push options to google map api to generate route and call drawroute to draw on the map
    generateRoute(formValues) {
        ...
        scounter = 0;
        //using the form values and various options to call the google map api
        this.directionsService.route({
            ...
            if (status === 'OK') {
                ...
                //calls draw route to show multiple route with 0 for checker
    ...
    //draws multiple or single route on the map based on checker.
    drawRoute(response, checker, routenum) {
        ...
        if (checker == 0) {
            ...
            //uses polyline so that events such  as click can be used as directionsRenderer cannot add event
            for (var h = 0, len = response.routes.length; h < len; h++) {
                ...
                gRoute[h].setMap(map);
                //calls draw route with 1 set for checker to indicate route is selected
            ...
            //if checker is 1, it means that user has selected a route and therefore event is not needed for route so directionsRenderer will do.
            ...
            //fine tuning the panel to make sure that the panel only display the route selected
            ...
            //clears the panel if user generates route again
    ...
    getlatandlang(selectedroute) {
        ...
        const sub = Object(rxjs__WEBPACK_IMPORTED_MODULE_8__["interval"])(2000);
    ...
    //TRACKING FUNCTION
    trackroute(latlist, longlist, latlonglist, count) {
        const that = this;
        let userlatlong = "";
        let distCheckpoint = 0;
        let checkpoint = 0;
        let distCheck = [];
        let distComplete = 0;
        let complete = 0;
...
//# sourceMappingURL=pages-navigate-navigate-module-es2015.js.map
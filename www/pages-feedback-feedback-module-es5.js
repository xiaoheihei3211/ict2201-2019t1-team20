...
module.exports = ".commentsLabel {\n  font-size: 15px;\n  align-content: center;\n}\n\nion-item ion-textarea {\n  border-radius: 30px !important;\n  padding-left: 30px !important;\n  font-size: 0.9em;\n  margin-bottom: 20px;\n  border: 1px solid black;\n  border-bottom: 1px solid black !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var FeedbackPage = /** @class */ (function () {
    function FeedbackPage(formBuilder, afAuth, alertController, router, afs, starService) {
    ...
    FeedbackPage.prototype.submitRating = function () {
        var _this = this;
        var _a = this, safety = _a.safety, speed = _a.speed, enjoyment = _a.enjoyment, comment = _a.comment;
        var record = {};
        record['speed'] = this.speed;
        record['safety'] = this.safety;
        record['enjoyment'] = this.enjoyment;
        record['comment'] = this.comment;
        this.starService.setStar(record).then(function (resp) {
            _this.speed;
            _this.safety;
            _this.enjoyment;
            _this.comment;
    ...
    FeedbackPage.prototype.feedbackAlert = function () {
    ...
    FeedbackPage.prototype.goHomePage = function () {
        this.router.navigate(['home/navigate']);
    };
    //safety
    FeedbackPage.prototype.logRatingChange = function (rating) {
        console.log("changed safety: ", rating);
        // do your stuff
    };
    //speed
    FeedbackPage.prototype.logRatingChange2 = function (rating) {
        console.log("changed speed: ", rating);
        // do your stuff
    };
    //enjoyment
    FeedbackPage.prototype.logRatingChange3 = function (rating) {

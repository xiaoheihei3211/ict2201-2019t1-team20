    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _angular_fire__WEBPACK_IMPORTED_MODULE_10__["AngularFireModule"].initializeApp(_firebase__WEBPACK_IMPORTED_MODULE_9__["default"], 'MappySteps'),
                ...
                _angular_fire_storage__WEBPACK_IMPORTED_MODULE_13__["AngularFireStorageModule"] // imports firebase/storage only needed for storage features
            ],
            providers: [
                _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
                _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"],
                { provide: _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicRouteStrategy"] },
                _user_service__WEBPACK_IMPORTED_MODULE_14__["UserReg"]
            ],
...
var UserReg = /** @class */ (function () {
    function UserReg(afAuth, afs) {
        this.afAuth = afAuth;
        this.afs = afs;
    }
    UserReg.prototype.setUser = function (user) {
        this.user = user;
    };
    UserReg.prototype.getUID = function () {
        return this.user.uid;
    };
    //feedback
    UserReg.prototype.setStar = function (rating) {
        return this.afs.collection('feedback').add(rating);
    };
    UserReg.prototype.getEmail = function () {
        return this.user.email;
    };
    UserReg.prototype.getCommute = function () {
        return this.user.email;
    };
    UserReg.prototype.getMobile = function () {
        return this.user.email;
    };
    UserReg.prototype.readUsrReward = function (uid) {
        return this.afs.collection('users');
    };
    UserReg.prototype.readRewards = function () {
        return this.afs.collection('toRedeem').snapshotChanges();
    };
    UserReg.prototype.update_Reward = function (rewardID, reward) {
        this.afs.doc('users/' + rewardID).update(reward);
    };
    UserReg.prototype.read_subcollection = function (uid) {
        return this.afs.collection('users').doc('/' + uid).collection('claimedRewards').snapshotChanges();
    };
    UserReg.prototype.add_reward = function (reward, uid) {
        return this.afs.collection('users').doc('/' + uid).collection('claimedRewards').add(reward);
    };
    //history Routes
    UserReg.prototype.read_history_routes = function (uid) {
        return this.afs.collection('users').doc('/' + uid).collection('historyRoutes').snapshotChanges();
    };
    UserReg.prototype.add_historyRoutes = function (routes, uid) {
        return this.afs.collection('users').doc('/' + uid).collection('historyRoutes').add(routes);
    };
    //point system
    UserReg.prototype.add_points = function (points, uid) {
        this.afs.doc('users/' + uid).update(points);
    };
    UserReg.prototype.add_totalPoints = function (points, uid) {
        this.afs.doc('users/' + uid).update(points);
    };
    UserReg.prototype.update_tier = function (tier, uid) {
        this.afs.doc('users/' + uid).update(tier);
    };
    UserReg.ctorParameters = function () { return [
        { type: _angular_fire_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"] },
        { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"] }
    ]; };
    UserReg = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
module.exports = __webpack_require__(/*! C:\Users\weiya\OneDrive\Desktop\SIT NOTES\YEAR 2 TRI 1\ICT2201 - Introduction to Software Engineering\Project\MappySteps_LoginReg\src\main.ts */"./src/main.ts");
